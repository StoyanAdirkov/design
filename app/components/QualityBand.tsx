 ...
 *
 * ВИДЕОТО Е ТЯХНО. Магазинът на maxxmart — витрината с логото и пътека
 * между рафтовете. Замени стоковия клип от Pexels, който стоеше тук
 * преди, и заедно с него отпадна нуждата надписът да заобикаля истината.
 *
 * Изходникът е квадратен (640×640, 5 сек). Качен е като квадрат, а не
 * изрязан предварително: CSS-ът го реже според ширината на колоната, а
 * при готов кроп широкият екран щеше да получи вече отрязан кадър и да
 * го отреже втори път. Мащабиран е до 1080 с лека резкост, защото
 * изходникът е по-малък от кутията при екран с двойна плътност.
 */
      ...
      <div className="grid items-stretch gap-0 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)]">
        ...
        <div className="relative aspect-[16/10] bg-gray-900 lg:aspect-auto lg:min-h-[22rem]">
          <video
            ...
            src="/video/magazin.mp4"
            poster="/video/magazin.jpg"
            autoPlay
            muted
            loop
            playsInline
            preload="metadata"
            aria-label="Магазин на maxxmart — витрината и пътека между рафтовете"
          />
          ...
          {/* Сега кадрите са техни, затова надписът може да говори за
              обекта на екрана. Числото е измерено — 1607 от 2000
              проверени продукта са налични. */}
          <p className="absolute bottom-4 left-4 right-16 text-[0.8rem] font-medium leading-snug text-white/95">
            Един от 26-те обекта в страната — 8 от 10 артикула са налични
            веднага.
          </p>
