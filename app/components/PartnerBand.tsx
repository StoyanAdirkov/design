 ...
 *     разрешение.
 *
 * Блокът стои зад ключ и е ВКЛЮЧЕН по изрично решение на клиентския
 * екип: това е макет за представяне и ако клиентът каже да отпадне,
 * отпада. Преди магазинът да тръгне живо обаче някой трябва да отговори
 * с „да“ на два въпроса:
 *   1. Има ли договор с bTV Media Group?
 *   2. Има ли писмено разрешение за логото на предаването?
 * При „не“ на който и да е от двата — `PARTNER_ENABLED = false`.
 *
